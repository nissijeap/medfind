        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Classification of Medicine</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Add Classification</li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <form class="form-horizontal" method="POST"  id="submitBrandForm" action="action/createCategories.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text"  class="form-control"id="class_name" placeholder="Medicine Type" name="class_name"  required="" pattern="^[a-zA-z]+$"/>
                                                </div>
                                            </div>
                                        </div>
